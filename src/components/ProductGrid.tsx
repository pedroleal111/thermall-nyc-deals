...
const ProductGrid = () => {
  const products = [
    ...
    },
    {
      ...
      rating: 4.5,
      reviews: 634,
      image: "https://images.unsplash.com/photo-1593546189050-2705e874df8c?q=80&w=735&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      badge: "Designer",
